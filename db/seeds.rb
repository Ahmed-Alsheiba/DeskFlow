...
# tickets = [
#   { title: "POS terminal not responding", description: "The POS terminal at front desk freezes after each transaction.", category: "POS", priority: "High", status: "In Progress", location: "Front Desk", submitter_name: "Alice Johnson", assigned_to: "Bob Smith" },
...
#   { title: "PMS check-in sync failure", description: "Guest check-ins are not syncing to the property management system.", category: "PMS", priority: "High", status: "In Progress", location: "Reception", submitter_name: "Frank White", assigned_to: "Grace Kim" },
...
#   { title: "Card reader not accepting AMEX", description: "AMEX cards are being declined at the bar POS terminal.", category: "POS", priority: "Medium", status: "In Progress", location: "Bar", submitter_name: "Olivia Chen", assigned_to: "Peter Davis" },
...
#   { title: "VPN access issue for remote staff", description: "Remote staff cannot connect to VPN since the last firewall update.", category: "Network", priority: "High", status: "In Progress", location: "Remote", submitter_name: "Sam Torres", assigned_to: "Tina Wallis" },
...
#   { title: "No audio on boardroom projector", description: "The projector in the boardroom displays video but has no audio output.", category: "Hardware", priority: "Low", status: "In Progress", location: "Boardroom", submitter_name: "Zoe Clarke", assigned_to: "Alice Johnson" },
# ]
